...
-- 데이터베이스 생성
CREATE DATABASE IF NOT EXISTS newtag 
...
-- 개발자 계정 생성
CREATE USER IF NOT EXISTS 'developer'@'%' IDENTIFIED BY 'P!ssw0rd';
...
(
  id          INT            NOT NULL AUTO_INCREMENT COMMENT '유저 주소 PK',
...
(
  id          INT         NOT NULL AUTO_INCREMENT COMMENT '카테고리 PK',
...
(
  id          INT                                   NOT NULL AUTO_INCREMENT COMMENT '상품 PK',
...
CREATE TABLE p_img
(
  id         INT          NOT NULL AUTO_INCREMENT COMMENT '상품 이미지 pk',
...
(
  id         INT      NOT NULL AUTO_INCREMENT COMMENT '찜 PK',
...
CREATE TABLE review
(
  id             INT      NOT NULL AUTO_INCREMENT COMMENT '후기 PK',
  rating         INT      NOT NULL CHECK (rating BETWEEN 1 AND 5) COMMENT '평점 (1-5)',
